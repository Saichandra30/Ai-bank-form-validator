...
try:
    ...
    CV2_AVAILABLE = False
    print("[WARNING] OpenCV not available. Installing: pip install opencv-python")
...
try:
    ...
    PIL_AVAILABLE = False
    print("[WARNING] PIL not available. Installing: pip install Pillow")
...
try:
    ...
    print("[WARNING] pytesseract not available. Installing: pip install pytesseract")
...
try:
    ...
    print("[WARNING] pdf2image not available. Installing: pip install pdf2image")
