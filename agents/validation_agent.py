...
Be thorough and specific in your validation."""
        ...
        try:
            ...
            print(f"[ERROR] Error validating form: {e}")
            return {
                "error": str(e),
                "status": "ERROR",
...
"""
        ...
        if missing:
            report += "[WARNING] MISSING REQUIRED FIELDS:\n"
        ...
        if violations:
            report += "[ERROR] POLICY VIOLATIONS:\n"
            for v in violations:
